...
import SalesforceLogoSombre from "../../public/assets/logo/Sharecopain.png";
import SalesforceLogoClair from "../../public/assets/logo/Sharecopain.png";
...
export default function Connection() {
  ...
  const handleFormSubmit = (event) => {
    ...
    for (const field in dataFromForm) {
      if (Object.hasOwnProperty.call(dataFromForm, field)) {
    ...
    axios
      .put(`${import.meta.env.VITE_BACKEND_URL}/users/${userInfos.id}`, dataToPutProfile, {
        headers: {
        ...
        axios
          ...
          .catch((error) => {
            if (error.response.status === 401) {
              ...
              setHasPutFailed({
                message:
                  "Vous ne disposez pas des droits nécessaires pour vous connecter à cette entreprise.",
                icon: "lock",
              });
        ...
        <div className="header">
          ...
          <div className="content">
            ...
            <div className="details">
              <p>Il semble que votre invitation ne soit plus valide.</p>
              <p>Contactez l'administrateur de votre entreprise ou connectez-vous.</p>
            </div>
          </div>
        </div>
        <div className="actions">
          <Link to={`/`} className="button-md-primary-solid">
            Me connecter
          </Link>
        </div>
      </div>
    ...
    <div id="sign-up">
      <div className="page">
        <div className="content">
          <header>
            <h1>Bienvenue !</h1>
            <p>Prêt·e à partager vos idées ? Créez votre compte très simplement.</p>
          </header>
          <form className="sign-up" onSubmit={handleFormSubmit}>
            <div className="elements">
              ...
              <div className="account">
                ...
                <div className="input-line">
                  <div className="input-field">
                    <label htmlFor="profile-password">Mot de passe (obligatoire)</label>
                    <div className="input">
                  ...
                  <div className="input-field">
                    <label htmlFor="password-confirmation">Confirmation (obligatoire)</label>
                    <div className="input">
                      <i className="fi fi-rr-lock" />
                      <input
                        type="password"
            ...
            <button type="submit" className="button-lg-primary-solid">
              C'est parti ! <i className="fi fi-rr-angle-right" />
            </button>
          </form>
          {hasPutFailed && (
            <Alert
