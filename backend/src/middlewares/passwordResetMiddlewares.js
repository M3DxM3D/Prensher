...
const sendResetPasswordMail = (req, res) => {
  ...
  const mailOptions = {
    ...
    <body>
        <span class="preheader" style="display: none !important; visibility: hidden; opacity: 0; color: transparent; height: 0; width: 0;">Réinitialisez votre mot de passe </span>
